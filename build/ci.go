...
import (
	...
	"github.com/wemixarchive/go-wemix/crypto/signify"
	"github.com/wemixarchive/go-wemix/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/wemixarchive/go-wemix/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/wemixarchive/go-wemix/mobile")
